...
Obtaining *Play Protect certified* status requires device manufacturers to pass "**Android compatibility**" device validation [[10]](https://source.android.com/docs/compatibility/compatibility-faq) and to become Google Mobile Services (GMS) partners [[11]](https://web.archive.org/web/20260625223004/https://www.android.com/gms/) [[12]](https://web.archive.org/web/20260530050020/https://www.android.com/gms/contact/). Such Android compatibility requires compliance with Android's _Compatibility Definition Document_ (CDD) and passing the _Compatibility Test Suite_ (CTS), which include both hardware and software requirements [[13]](https://source.android.com/docs/compatibility/overview), covering both security and non-security criteria [[14]](https://source.android.com/docs/compatibility/17/android-17-cdd#9_security_model_compatibility).
